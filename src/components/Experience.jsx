        ...
        {experienceData.map((job, index) => (
          <Reveal key={`${job.company}-${index}`} delay={index * 100} className="mb-10 last:mb-0">
            <div className="group relative">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-glass backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-sky-300/30 hover:bg-white/10 hover:shadow-[0_15px_40px_rgba(2,132,199,0.15)]">
