      ...
      <div className="flex flex-col gap-8 mt-6">
        {visibleRepos.map((repo, index) => (
          <Reveal key={repo.id} delay={(index % 3) * 100}>
            <a href={repo.html_url} target="_blank" rel="noreferrer" className="block outline-none rounded-2xl ring-sky-400 focus-visible:ring-2">
              <article className="ml-card group flex flex-col md:flex-row overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-glass backdrop-blur-xl transition-all duration-500 hover:-translate-y-1.5 hover:border-sky-300/40 hover:bg-white/10 hover:shadow-[0_15px_50px_rgba(2,132,199,0.2)]">
                <div className="relative aspect-[16/9] w-full md:w-[45%] shrink-0 overflow-hidden border-b md:border-b-0 md:border-r border-white/10 bg-slate-900/70">
                ...
                <div className="flex flex-1 flex-col p-6 md:p-8 justify-center">
